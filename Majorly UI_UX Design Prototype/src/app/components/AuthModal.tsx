...
interface AuthModalProps {
  ...
  trigger?: "save" | "deepdive";
}

export function AuthModal({ isOpen, onClose, onAuth, trigger = "save" }: AuthModalProps) {
        ...
        >
          ...
          <div className="relative p-6 border-b border-gray-200">
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#4F46E5] to-[#7C3AED] flex items-center justify-center mx-auto mb-3">
                <User className="w-6 h-6 text-white" />
              </div>
              <h2 className="text-2xl font-bold">
                {trigger === "save" ? "Save Your Journey" : "Unlock Deep Dive"}
              </h2>
              <p className="text-[#64748b] mt-2">
                {trigger === "save" 
                  ? "Create an account to save your favorite majors and track your progress."
                  : "Create an account to access personalized specializations and course recommendations."}
              </p>
            </div>
          </div>
          ...
          <div className="p-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-12 rounded-2xl bg-[#f1f5f9] border-0"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                onClick={() => onAuth({ name: "Demo User", email: "demo@majorly.com" })}
              >
