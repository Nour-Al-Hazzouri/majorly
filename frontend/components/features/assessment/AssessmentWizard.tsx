                    ...
                    <Alert variant="destructive" className="bg-red-50 border-red-200 rounded-2xl shadow-sm border-2 animate-in fade-in slide-in-from-top-4 duration-700">
                        ...
                        <AlertDescription className="text-red-800/80 text-sm leading-relaxed">
                            ...
                            <ul className="list-disc pl-5 mt-1 space-y-1">
                                ...
                                <li>We encourage users to cross-reference these findings with the official sources (O*NET and ESCO) linked on the <Link href="/about" className="font-bold underline hover:text-red-950 transition-colors inline-flex items-center gap-1">About Us <ExternalLink size={12} /></Link> page.</li>
                            </ul>
                        </AlertDescription>
                    </Alert>
                </div>
